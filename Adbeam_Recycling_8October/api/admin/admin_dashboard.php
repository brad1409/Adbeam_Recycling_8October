                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="?edit_user=<?= $user['user_id'] ?>" class="btn btn-outline-primary" 
            ...
            <div class="modal-content">
                <form method="POST">
                    <div class="modal-header">
                        <h5 class="modal-title"><?= $editUser ? 'Edit User' : 'Add User' ?></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" class="form-control" required 
                                   value="<?= htmlspecialchars($editUser['college_email'] ?? '') ?>">
                        </div>
